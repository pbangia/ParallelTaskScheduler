...
public class EndToEndTest_Parallel {
    ...
    @Test
    public void testNodes7_TwoProcessorsTwoThreads_ReturnsCorrectLength() throws Exception {
    ...
    @Test
    public void testNodes8_TwoProcessorsTenThreads_ReturnsCorrectLength() throws Exception {
        inputFile = "Nodes_8_Random.dot";
        numProcessors = 2;
        outputFile = "output.dot";
        numThreads = 10;
    ...
    @Test
    public void testNodes9_TwoProcessorsTenThreads_ReturnsCorrectLength() throws Exception {
        inputFile = "Nodes_9_SeriesParallel.dot";
        numProcessors = 2;
        outputFile = "output.dot";
        numThreads = 10;
    ...
    @Test
    public void testNodes10_TwoProcessorsTenThreads_ReturnsCorrectLength() throws Exception {
        inputFile = "Nodes_10_Random.dot";
        numProcessors = 2;
        outputFile = "output.dot";
        numThreads = 10;
